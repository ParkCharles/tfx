...
def orchestrate(
    ...
    service_jobs_manager: Optional[service_jobs.ServiceJobsManager] = None
) -> None:
  ...
  Args:
    ...
    service_jobs_manager: An optional `ServiceJobsManager` instance if service
      jobs are supported.
...
def _process_stop_initiated_pipelines(
    ...
    service_jobs_manager: Optional[service_jobs.ServiceJobsManager],
...
def _ensure_services(service_jobs_manager: service_jobs.ServiceJobsManager,
