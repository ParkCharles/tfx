...
def _generate_artifact_properties(spec: pipeline_pb2.OutputSpec.ArtifactSpec,
                                  artifact: types.Artifact):
  """Generates properties of an artifact using ArtifactSpec."""
...
class OutputsResolver:
  ...
  def generate_output_artifacts(
    ...
    for key, output_spec in self._pipeline_node.outputs.outputs.items():
      ...
      _generate_artifact_properties(output_spec.artifact_spec, artifact)
